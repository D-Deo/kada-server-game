...
class Formation {
    ...
    compare(f) {
        if (this.type == zjhcons.Formation.SPECIAL() && f.getType() == zjhcons.Formation.BOMB()) {
            return 1;
        }

        if (this.type == zjhcons.Formation.BOMB() && f.getType() == zjhcons.Formation.SPECIAL()) {
            return -1;
        }
    ...
    __print() {
        let s = '垃圾';
        switch (this.type) {
            case zjhcons.Formation.SPECIAL():
                s = '特殊';
                break;
            case zjhcons.Formation.HIGH():
                s = '高牌';
                break;
            case zjhcons.Formation.PAIR():
                s = '对子';
                break;
            // case zjhcons.Formation.TWO_PAIR():
            //     s = '两队';
            //     break;
            // case zjhcons.Formation.TRIPLE():
            //     s = '三条';
            //     break;
            case zjhcons.Formation.SEQUENCE():
                s = '顺子';
                break;
            case zjhcons.Formation.SUIT():
                s = '金花';
                break;
            // case zjhcons.Formation.TRIPLE_PAIR():
            //     s = '三条';
            //     break;
            case zjhcons.Formation.BOMB():
                s = '豹子';
                break;
            case zjhcons.Formation.SUIT_SEQUENCE():
                s = '顺金';
                break;
            // case zjhcons.Formation.SUIT_SEQUENCE_ACE():
            //     s = '同花大顺';
            //     break;
        }
        return s;
